...
class VdscConfig:
    ...
    def _initialize(self):
        self.aws = {
            ...
            'account_id': os.getenv('AWS_ACCOUNT_ID', '080145351546')}
        self.s3_bucket = {
        ...
        self.vdsc = {
            'png_compression_level': int(os.getenv('PNG_COMPRESSION_LEVEL', '9')),
            'zip_compression_level': int(os.getenv('ZIP_COMPRESSION_LEVEL', '5')),
            'quality':{
                'ultra': 1080,
                'high': 720,
                'medium': 480,
